...
def main():
    ...
    parser.add_argument("--model", default="/models/guardrail-gemma4-e2b")
    ...
    if args.chat_template not in ("model_default", "default", "auto"):
        tokenizer = get_chat_template(tokenizer, chat_template=args.chat_template)
    chat_processor = tokenizer
